/*
  ...
  todo:
  fixup userland editable PWM frequency and set limits for oscillation 
  fixup locking mechanism
  fixup display prettyness
  write my own graphics lib with better fonts and smoothing
